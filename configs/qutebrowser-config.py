...
## Type: String
## c.content.headers.user_agent = "Chrome 41"
...
## Type: Font
c.fonts.completion.entry = '13pt "DejaVu Sans Mono"'
...
## Type: Font
c.fonts.hints = 'bold 13pt "DejaVu Sans Mono"'

## Font used in the keyhint widget.
## Type: Font
c.fonts.keyhint = '13pt "DejaVu Sans Mono"'
...
## Type: Font
c.fonts.prompts = '13pt "System San Francisco Display Regular"'

## Font used in the statusbar.
## Type: Font
c.fonts.statusbar = '13pt "System San Francisco Display Regular"'

## Font used in the tab bar.
## Type: QtFont
c.fonts.tabs = '13pt "System San Francisco Display Bold"'
