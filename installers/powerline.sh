...
ln -sf "${RCS}/powerline/powerline-shell.json" ~/.config/powerline/themes/shell/default.json
ln -sf "${RCS}/powerline/powerline-tmux.json" ~/.config/powerline/themes/tmux/default.json
